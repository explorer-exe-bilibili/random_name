...
private:
    ...
    RegionName currentRegionName = RegionName::SMALL_WINDOW; // 当前区域名称
...
public:
    ...
    Region getRegion(const std::string& name, const RegionName& category=RegionName::NONE ,const Region& defaultValue = {});
